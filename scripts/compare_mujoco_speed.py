...
@click.command()
@click.option('--impl', type=click.Choice(['jax', 'warp']), default='jax', help='Implementation to use (jax or warp)')
@click.option('--n_envs', type=int, default=2048, help='Number of parallel environments')
def main(impl, n_envs):
